...
<template>
    <div v-if="videoArray" class="grid md:grid-cols-[4fr_1fr] overflow-y-auto">
        ...
        <div id="right-sidebar" class="ml-2 border-yellow-400 border-solid border-2">
            ...
            <div
                ...
                :key="index"
                @click="goToVideo(vid)"
                class="grid md:grid-cols-[repeat(2,160px)] cursor-pointer border-purple-800 border-solid border-2"
            >
                ...
                <div class="flex flex-col border-green-400 border-solid border-2">
                    <div class="font-extrabold w-full cursor-pointer">{{ vid.title }}</div>
                    <div class="pb-0.5 w-full text-gray-300 font-extrabold cursor-pointer">{{ vid.name }}</div>
