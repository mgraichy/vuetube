    ...
    <div v-if="videoArray" class="grid grid-cols-[.72fr.28fr] overflow-y-auto">
        ...
        <div id="right-sidebar" class="ml-2 border-yellow-400 border-solid border-2">
            <div
                ...
                :key="index"
                @click="goToVideo(vid)"
                class="flex cursor-pointer border-purple-800 border-solid border-2"
            >

                <div class="aspect-video cursor-pointer mb-2 border-red-400 border-solid border-2">
                    <video class="max-w-full h-auto rounded" :src="domain + vid.src" type="video/mp4"></video>
                </div>

                <div class="flex-col border-green-400 border-solid border-2">
